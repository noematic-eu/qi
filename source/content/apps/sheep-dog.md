---
title: Sheep Dog
subtitle: Herd the flock, close the gate, chase the stars
pubDate: 2026-07-30
isPaid: true
platforms:
  - macOS
...
Sheep Dog is a tiny pastoral score-attack: no farming sim, no multiplayer — just you, the flock, and the clock.

<br>

> Herd them in. Close the gate. Beat your best time.
...
- **12 campaign trials** — 2 tutorials + 10 pastures with unlocks and star ratings  
- **Endless mode** — procedural maps for replay  
- **Score-attack stars** — gold / silver / bronze pars on the HUD  
- **Pasture Soft look** — procedural characters and soft palette  
- **Audio** — ambient pasture, bleats, pen ding, win jingle; mute with **M**  
- **Keyboard or pointer** — WASD / arrows or mouse / finger  

### Controls

| Action | Input |
|--------|--------|
| Move dog | WASD / arrows or mouse / finger |
| Open gate | O (or scroll at pen) |
| Close gate | F (or scroll at pen) |
| Pause | Esc |
| Mute | M |
| Retry (after win) | R |
| Next trial | Enter |

**Win:** all sheep inside the pen **and** gate closed.

### Tips

#### Approach from behind

Sheep flee the dog. Come from behind the flock to push them toward the pen instead of scattering them.

#### Gate discipline

Open the gate to let sheep in, then **close** it to finish. Leaving it open invites escapes.

#### Stars, not cruelty

There is no hard fail timer — go slow if you need to. Faster runs earn more stars.

### Frequently Asked Questions {#faq}

#### Is this a farming sim?
